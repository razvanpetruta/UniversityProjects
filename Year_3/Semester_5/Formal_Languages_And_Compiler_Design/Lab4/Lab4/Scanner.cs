...
public class Scanner
{
    ...
    private FiniteAutomaton _idenfifierFA;
    private FiniteAutomaton _intConstantFA;
    ...
    public Scanner()
    {
        ...
        _idenfifierFA = new FiniteAutomaton("FiniteAutomaton/identifierFA.txt");
        _intConstantFA = new FiniteAutomaton("FiniteAutomaton/int_constantFA.txt");
        ResetFields();
        try
        {
            ReadTokens();
    ...
    {
        string? match = _idenfifierFA.GetTokenFromFA(_program.Substring(_index));
    ...
    {
        string? match = _intConstantFA.GetTokenFromFA(_program.Substring(_index));
        ...
        if (char.IsLetter(_program[_index + match.Length]) || _program[_index + match.Length] == '_')
        {
            return false;
        }
