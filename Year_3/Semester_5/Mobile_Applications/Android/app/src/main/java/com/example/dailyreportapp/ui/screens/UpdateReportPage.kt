...
fun UpdateReportPage(
    ...
    dailyReport: DailyReport // Pass the daily report to edit
) {
    var title by rememberSaveable { mutableStateOf(dailyReport.title) }
    var gratitude by rememberSaveable { mutableStateOf(dailyReport.gratitude) }
    var accomplishments by rememberSaveable { mutableStateOf(dailyReport.accomplishments) }
    var shortcomings by rememberSaveable { mutableStateOf(dailyReport.shortcomings) }
    var improvementAreas by rememberSaveable { mutableStateOf(dailyReport.improvementAreas) }
    var rating by rememberSaveable { mutableIntStateOf(dailyReport.rating) }
    ...
    Column(
        ...
        TopAppBar(
            title = { Text("Update Daily Report") },
            navigationIcon = {
                IconButton(
                    onClick = {
        ...
        Button(
            onClick = {
                ...
                dailyReport.gratitude = gratitude
                dailyReport.accomplishments = accomplishments
                dailyReport.shortcomings = shortcomings
                dailyReport.improvementAreas = improvementAreas
                dailyReport.rating = rating
                dailyReport.date = Calendar.getInstance().time

                dailyReportsViewModel.updateReport(dailyReport)
                navController.popBackStack()
            },
            modifier = Modifier.fillMaxWidth(),
        ) {
