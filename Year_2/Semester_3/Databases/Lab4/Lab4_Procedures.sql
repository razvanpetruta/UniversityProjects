-- Procedures to simplify the process for adding specific tests, tables, views and for 
-- creating the connections between them
...
BEGIN
	...
	SET @command = 'populateTable' + @tableName
...
BEGIN
	...
	VALUES ('test results for test: ' + @testName)
