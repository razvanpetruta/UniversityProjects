...
-- holds data about tables that can take part in tests
CREATE TABLE [Tables] (
...
-- junction between Tests and Tables
...
-- junction between Tests and Views
...
-- holds data about a set of views in the database, used to assess the performence of certain SQL queries
CREATE TABLE [Views] (
