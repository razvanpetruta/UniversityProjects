...
class BookService:
    ...
    def search_by_author(self, info):
        ...
        """
        def custom_sort(book1, book2):
            return book1.author.lower().index(info) <= book2.author.lower().index(info)
    ...
    def list_of_books(self):
        ...
        """
        return self.__repo.list_of_books
