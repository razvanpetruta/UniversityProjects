...
class ClientService:
    ...
    def list_of_clients(self):
        ...
        """
        clients_list = []
        for key in self.__repo.clients:
            clients_list.append(self.__repo.clients[key])
        return clients_list

    def populate(self):
        """
        Populate the repository with 20 randomly generated entries, using Generator class.
        """
        while len(self.__repo) != 20:
