...
class RentalRepository:
    ...
    def find_book_in_rentals(self, book_id):
        ...
        for key in self._rentals:
            if self._rentals[key].book_id == book_id and self._rentals[key].returned_date is None:
                return self._rentals[key]
        return None
    ...
    def rent_date_greater_than_return_date(self, book_id, rented_date):
        ...
        """
        for key in self._rentals:
            if self._rentals[key].book_id == book_id and self._rentals[key].returned_date > rented_date:
                return self._rentals[key]
        return None
    ...
    def find_book_with_client(self, book_id, client_id):
        ...
        """
        for key in self._rentals:
            if self._rentals[key].book_id == book_id and self._rentals[key].client_id == client_id and \
                    self._rentals[key].returned_date is None:
                return self._rentals[key]
        return None
