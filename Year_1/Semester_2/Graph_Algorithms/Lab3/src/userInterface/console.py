...
from graphRepresentation.graph import Graph, read_from_file, write_to_file, read_from_big_file
...
class Console:
    ...
    def generate_random_graph(self):
        ...
        while graph.no_of_edges < no_of_edges:
            ...
            if graph.check_edge(x, y) is None:
    ...
    def get_graph_from_big_file(self):
        path = input("path to the file: ")
        self.__graph = read_from_big_file(path)
    ...
    def modify_edge_info(self):
        x, y = Console.read_edge()
        new_cost = int(input("new cost: "))
        self.__graph.change_cost(x, y, new_cost)
    ...
    def find_minimum_cost_path(self):
        print("path from x to y")
        x = int(input("x: "))
        y = int(input("y: "))
        self.__graph.floyd_warshall(x, y)
    ...
    def start(self):
        ...
        commands = {
            ...
            11: self.test_edge,
            12: self.modify_edge_info,
            13: self.add_vertex_to_graph,
            14: self.remove_vertex_from_graph,
            15: self.add_edge_to_graph,
            16: self.remove_edge_from_graph,
            17: self.parse_graph,
            18: self.get_graph_from_big_file,
            19: self.find_minimum_cost_path
        }
        while True:
            try:
                Console.print_menu()
